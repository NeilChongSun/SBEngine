...
private:
	...
	{
		SB::Math::Matrix4 boneTransforms[128] = {};
	};
	...
	using BoneTransformBuffer = SB::Graphics::TypedConstantBuffer<BoneTransformData>;
	...
	float mTime=0;
	SB::Math::Matrix4 mTransform=SB::Math::Matrix4::Identity;

	SB::Graphics::Animator mAnimator;
