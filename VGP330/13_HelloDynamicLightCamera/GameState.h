...
private:
	...
	SB::Math::Matrix4 mLightProjectMatrix;
	std::vector<SB::Math::Vector3> mViewFrustumVertices;
	...
	std::vector<SB::Math::Vector3> mTankPositions;
	SB::Math::Vector3 mTankRotation = 0.0f;
