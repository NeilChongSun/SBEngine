...
void GameState::Initialize()
{
	...
	mTankPosition = Vector3{ 0.0f, 3.5f, 0.0f };
	...
	mPlaneMesh = MeshBuilder::CreatePlane(100.0f);
	...
	mPostProcessingSettingBuffer.Initialize();
	...
	mPlaneMap.Initialize("../../Assets/grass_2048.jpg");
...
void GameState::Terminate()
{
	...
	mPostProcessingSettingBuffer.Terminate();
