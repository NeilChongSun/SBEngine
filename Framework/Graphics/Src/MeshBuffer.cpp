...
void SB::Graphics::MeshBuffer::InitializeInternal(const void* vertices, int vertexSize, int vertexCount, const uint32_t* indices, int indexCount, bool dynamic)
{
...
void SB::Graphics::MeshBuffer::Terminate()
{
	SafeRelease(mIndexBuffer);
	SafeRelease(mVertexBuffer);
}

void SB::Graphics::MeshBuffer::SetTopology(Topology topology)
{
...
void SB::Graphics::MeshBuffer::Update(const void * vertexData, uint32_t numVertices)
{
...
void SB::Graphics::MeshBuffer::Draw() const
{
	auto context = GetContext();
